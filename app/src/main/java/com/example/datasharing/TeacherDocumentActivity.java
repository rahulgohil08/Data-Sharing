...
public class TeacherDocumentActivity extends AppCompatActivity implements DocumentAdapter.DocumentInterface {
    ...
    private void init() {
        ...
        binding.fab.setOnClickListener(v -> openActivity(CreateDocumentActivity.class));
        ...
        new Thread(() -> {
            documentList.clear();
            documentList.addAll(dao.getTeacherDocuments(teacherId));
            runOnUiThread(() -> {
